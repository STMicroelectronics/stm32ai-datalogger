...
#define MAX_SEND_PACKET_SIZE 64
...
extern USBD_HandleTypeDef hUsbDeviceFS; // declared in usb_device.c
extern ai_logging_device_t device; // declared in main.c
/* USER CODE END PV */
...
uint32_t usb_cdc_send_function(uint8_t *data_ptr, uint32_t data_size)
{
